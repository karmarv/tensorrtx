...
# load custom plugins
cwd_path = os.getcwd()
PLUGIN_LIBRARY = os.path.join(cwd_path,"tensorrtx/yolov5/","build/libmyplugins.so")
engine_file_path = os.path.join(cwd_path,"tensorrtx/yolov5/","build/yolov5s.engine")
print("Loading engine path: ", engine_file_path)
